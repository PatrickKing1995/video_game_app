...
class FriendDetailsWidget extends StatelessWidget {
  final Friend friend;

  FriendDetailsWidget({this.friend});
    ...
    return ClipPath(
      ...
      child: Container(
        padding: const EdgeInsets.only(
            left: 20.0, right: 16.0, top: 35.0, bottom: 12.0),
        height: 270.0,
        color: Colors.white,
//        child: Column(
//          children: <Widget>[
...
class MyCustomClipper extends CustomClipper<Path> {
  final double distanceFromWall = 20;
  ...
  Path getClip(Size size) {
    ...
    clippedPath.lineTo(width - distanceFromWall, height);
    clippedPath.quadraticBezierTo(width-controlPointDistanceFromWall,
        height - controlPointDistanceFromWall, width , height - distanceFromWall);
